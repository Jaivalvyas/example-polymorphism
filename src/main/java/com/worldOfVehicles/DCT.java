...
public class DCT {
    void showSpecs(String s, String s1, long forward_gears, double first_gear_ratio, double second_gear_ratio, double third_gear_ratio, double fourth_gear_ratio, double fifth_gear_ratio, double sixth_gear_ratio,
                   double seventh_gear_ratio, double eigth_gear_ratio) {
        ...
        System.out.println("8. 7th Gear ration: " + seventh_gear_ratio);
        System.out.println("9. 8th Gear ration: " + eigth_gear_ratio);
    }
}
